...
import { FaGlassCheers, FaHandsHelping, FaPlane, FaMicrophone, FaCalendarWeek } from "react-icons/fa";
  ...
  return (
    <div className={styles.servicesPage}>
      ...
      <section className={styles.ctaSection}>
        <div className={styles.container}>
          <h2 className={styles.ctaTitle} style={{ color: "white" }}>Ready to Plan Your Next Corporate Event?</h2>
